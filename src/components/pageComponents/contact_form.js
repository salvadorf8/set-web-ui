...
class ContactForm extends Component {
    ...
    render() {
        ...
        return (
            <section className="bg-dark" id="contactform">
            <form name="contact" onSubmit={handleSubmit(this.onSubmit.bind(this))}>
                <div className="container">
                    ...
                    <div className="form-row mt-2">
                        ...
                        <h5 className="section-heading text-white mt-4 text-center">Low Voltage Cabling</h5>
                        <hr className="mt-1" />
                        ...
                        <div className="form-group col-md-4">
                            <h5 className="section-heading text-white mt-4 text-center">Access Control</h5>
                            <hr className="mt-1" />
                        ...
                        <div className="form-group col-md-4">
                            <h5 className="section-heading text-white mt-4 text-center">CCTV</h5>
                            <hr className="mt-1" />
